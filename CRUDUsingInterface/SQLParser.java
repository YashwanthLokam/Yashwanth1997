...
class SQLParser
{
	...
	{
		String updatedQuery = removeExtraSpacesInQuery(query);
		String[] tempData = updatedQuery.split(" ");
	...
	public String[] getFieldNames(String query)
	{
		String updatedQuery = removeExtraSpacesInQuery(query);
		String fieldNames = "";
		String tempData = updatedQuery.replaceAll("[(,)]", "");
	...
	public String removeExtraSpacesInQuery(String query)
	{
		return query.replaceAll("[ ]{2,}", " ");
	}
}